...
class SendMessage:
    def __init__(self):
        self.corp_id = config.get_config("wework", "corp_id")
        self.app_secret = config.get_config("wework", "app_secret")
    ...
    def send_mpnews_message(self, title, content, touser="@all"):
        if config.get_config("wework", "media_id") is None:
        ...
        data = {
            ...
            "mpnews": {
                "articles": [
                    {
                        "title": title,
                        "thumb_media_id": config.get_config("wework", "media_id"),
                        "author": "Author",
    ...
    def send_message(self, title: str, content: str, touser: str = "@all", type: str = "text"):
...
def main():
    ...
    wework.send_message("测试1235", "测试666", "user1")
